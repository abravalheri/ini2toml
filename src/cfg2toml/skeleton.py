...
``[options.entry_points]`` section in ``setup.cfg``::
    ...
    console_scripts =
         fibonacci = cfg2toml.skeleton:run
...
from cfg2toml import __version__
...
# `from cfg2toml.skeleton import fib`,
...
def parse_args(args: List[str]) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--version",
        action="version",
        version="cfg2toml {ver}".format(ver=__version__),
    )
